...
|---------|----:|---:|--------:|---:|----:|--------------:|
| Estrelas | 29516 | 34280 | 42918 | 62338 | 471704 | 46311 |
| Idade (dias) | 44 | 1842 | 3087 | 4168 | 6535 | 1488 |
| PRs aceitas | 0 | 172 | 736 | 3198 | 94567 | 9847 |
| Releases | 0 | 0 | 40 | 145 | 1000 | 199 |
| Dias desde update | 0 | 0 | 0 | 0 | 3 | 0.14 |
| Razão issues fechadas | 0.0000 | 0.6779 | 0.8664 | 0.9597 | 1.0000 | 0.2567 |
...
Dos 905 repositórios com linguagem definida, **475 (52.5%)** utilizam uma das 3 linguagens mais populares do Octoverse 2025.

### 3.4 RQ07 — Comparação entre Grupos de Linguagem

| Grupo | PRs aceitas (med.) | Releases (med.) | Dias desde update (med.) |
|-------|-------------------:|----------------:|-------------------------:|
| Top 3 Octoverse | 970 | 64 | 0 |
| Outras linguagens | 781 | 43 | 0 |

**Teste de Mann-Whitney U (α = 0.05):**

| Métrica | Estatística U | p-valor | Significativo? |
|---------|-------------:|--------:|---------------:|
| PRs aceitas | 106448 | 0.271013 | Não |
| Releases | 111966 | 0.011690 | Sim |
| Dias desde update | 102555 | 0.178710 | Não |
...
**RQ01 — Maturidade:**  
A mediana de idade é **3087 dias (~8.5 anos)**, com 85% dos repositórios tendo mais de 3 anos. **Hipótese confirmada:** repositórios populares são, de fato, projetos maduros com histórico consolidado. Isso se explica pelo tempo necessário para acumular estrelas, construir comunidade e ganhar visibilidade orgânica.

**RQ02 — Contribuição externa:**  
A mediana de **736 PRs aceitas** indica contribuição externa significativa, embora a distribuição seja extremamente assimétrica (média de 3947, desvio padrão de 9847). **Hipótese confirmada:** a visibilidade de fato atrai colaboradores, mas a intensidade varia muito — alguns projetos recebem dezenas de milhares de PRs, enquanto outros (tipicamente listas curadas) recebem poucas.

**RQ03 — Releases:**  
A mediana de **40 releases** sugere adoção moderada de releases formais, com 29.2% dos repositórios sem nenhuma release. **Hipótese parcialmente confirmada:** muitos projetos populares (especialmente listas curadas, recursos educacionais e bibliotecas que usam distribuição via gerenciadores de pacotes) não utilizam o sistema de releases do GitHub.

**RQ04 — Atualização:**  
A mediana de **0 dias** desde o último update, com 99.6% atualizados no mesmo dia da coleta. **Hipótese confirmada:** esses repositórios são mantidos com altíssima frequência, praticamente em tempo real.

**RQ05 — Linguagens:**  
**52.5%** dos repositórios com linguagem definida usam TypeScript, Python ou JavaScript. Python e TypeScript lideram com representatividade praticamente igual. **Hipótese confirmada:** a maioria dos repositórios populares é escrita nas linguagens mais populares do ecossistema.

**RQ06 — Issues fechadas:**  
A mediana da razão de issues fechadas é **0.8664 (86.6%)**, com 73.4% dos repositórios acima de 70%. **Hipótese confirmada:** a maioria dos projetos populares mantém uma taxa elevada de resolução de issues, indicando manutenção ativa e responsiva.
...
4. **Atualização quase em tempo real** — 99.6% dos repositórios foram atualizados no mesmo dia da coleta, reforçando a natureza dinâmica desses projetos.
...
Os 1000 repositórios mais populares do GitHub são, em sua grande maioria, **projetos maduros** (mediana de ~8 anos), **ativamente mantidos** (atualizados diariamente), com **contribuição externa expressiva** (mediana de 736 PRs aceitas) e **alta taxa de resolução de issues** (86.6%). Mais da metade (52.5%) utiliza linguagens do Top 3 do GitHub Octoverse 2025 (TypeScript, Python, JavaScript).
